...
# Capture Screen
Set-PSReadLineKeyHandler -Chord 'Ctrl+C,Ctrl+P' -Function CaptureScreen
...
function firefoxlocal($port) {
    Start-Process "firefox.exe" "http://localhost:$port"
}

function ie() {
    Start-Process "edge.exe"
}

function ielocal($port) {
